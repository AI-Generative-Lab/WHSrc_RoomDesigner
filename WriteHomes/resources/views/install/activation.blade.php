...
<div class="container vertical-center">
    <div class="row justify-content-md-center">
                ...
                <div class="col-md-6 col-sm-12">   
                    ...
                    <div class="card overflow-hidden border-0 special-shadow">	
                        ...
                        <div class="card-body">                                                  
                            ...
                            <h3 class="text-center font-weight-bold fs-16 mb-4 mt-3">{{ __('Migrate Database') }}</h3>
                            ...
                            <form action="{{ route('install.activation.activate') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div hidden id="install-wrapper">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12">								
                                            <div class="input-box">								
                                                <h6>{{ __('Input') }}</h6>
                                                <div class="form-group">							    
                                                    <input type="text" class="form-control @error('license') is-danger @enderror" id="license" name="license" value="cbdba4f0-403e-47a5-a9bd-d528ca845b0c" autocomplete="off" required>
                                                    @error('license')
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">								
                                            <div class="input-box">								
                                                <h6>{{ __('Input') }}</h6>
                                                <div class="form-group">							    
                                                    <input type="text" class="form-control @error('username') is-danger @enderror" id="username" name="username" value="AzureusMihawk" autocomplete="off" required>
                                                    @error('username')
                ...
                <div class="form-group mb-0 text-center">                        
                    <button type="submit"  class="btn btn-primary pr-7 pl-7">{{ __('Install') }} <i class="fa fa-angle-double-right ml-1"></i></button>                                               
                </div>
            </form>    
        </div>
