                    ...
                    <div class="row d-flex" id="solutions-list">
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="solution" data-aos="zoom-in" data-aos-delay="1000" data-aos-once="true" data-aos-duration="1000">                                                                          
                                    ...
                                    <div class="solution-content">
                                        ...
                                        <p>{{ __('Latest AI technology includes GPT-3, GANs, Federated Learning, Reinforcement Learning, and Quantum Machine Learning.') }}</p>
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="solution" data-aos="zoom-in" data-aos-delay="1500" data-aos-once="true" data-aos-duration="1500">
                                    ...
                                    <div class="solution-content">
                                        ...
                                        <p>{{ __('AI technology supports 25+ languages, enabling users worldwide to communicate and generate text in their preferred language.') }}</p>
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="solution" data-aos="zoom-in" data-aos-delay="2000" data-aos-once="true" data-aos-duration="2000">
                                    ...
                                    <div class="solution-content">
                                        ...
                                        <p>{{ __('2FA (two-factor authentication) adds an extra layer of security to user accounts by requiring two forms of identification before access is granted.') }}</p>
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="solution" data-aos="zoom-in" data-aos-delay="1000" data-aos-once="true" data-aos-duration="1000">
                                    ...
                                    <div class="solution-content">
                                        ...
                                        <p>{{ __('Revolutionize your writing with AI-powered text editors. Edit with ease, correct grammar and spelling errors, and improve readability in seconds.') }}</p>
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="solution" data-aos="zoom-in" data-aos-delay="1500" data-aos-once="true" data-aos-duration="1500">
                                    ...
                                    <div class="solution-content">
                                        ...
                                        <p>{{ __('Easily export AI-generated text results in PDF and Word formats with just a few clicks. Ideal for businesses and content creators who need professional-looking documents for sharing and distribution.') }}</p>
                            ...
                            <div class="col-sm-12 mb-6">
                                ...
                                <div class="solution" data-aos="zoom-in" data-aos-delay="2000" data-aos-once="true" data-aos-duration="2000">
                                    ...
                                    <div class="solution-content">
                                        ...
                                        <p>{{ __('Create images using AI technology by simply describing them in text. We use machine learning algorithms to generate high-quality visuals from text.') }}</p>
                        ...
                        <div class="col-md-4 col-sm-12 d-flex">
                            ...
                            <div class="feature-text">
                                <div>
                                    <h4><span class="text-primary">{{ config('app.name') }}</span> {{ __('utilizes sophisticated AI technology to provide efficient and effective support to users') }}</h4>
                                </div>
                                
                                <p>{{ __('This technology includes natural language processing, machine learning, and deep learning algorithms that enable the bot to understand and respond to user queries in a human-like manner. This feature ensures that users receive accurate and personalized support, resulting in a seamless customer experience.') }}</p>
                            </div>
