...
const options = {
  ...
  styles: {
    colors: {
      ...
      shade800: "#000", // File item background
...
const Home: NextPage = () => {
  ...
  useEffect(() => {
    if (window.self === window.top) {
      ...
      if (redirectURL) {
        ...
        console.error("Redirect URL not defined in ENV file");
      }
    }
  }, []);
  ...
  return (
    <div className="text-black flex max-w-6xl mx-auto flex-col items-center justify-center py-2 min-h-screen">
      <Head>
        <title>Write Homes</title>
      </Head>
      <Header />
      <main className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 mt-4 sm:mb-0 mb-8">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="border border-black rounded-2xl py-2 px-4 text-black-400 text-sm my-6 duration-300 ease-in-out hover:text-black transition"
        >
          <span className="font-semibold text-black">Let's create a fantastic room design! </span> Exclusive from us!
        </a>
        ...
        <ResizablePanel>
          <AnimatePresence mode="wait">
            <motion.div className="flex justify-between items-center w-full flex-col mt-4">
              ...
              {restoredImage && (
                <div>
                  Here is your remodeled <b>{room.toLowerCase()}</b> in{" "}
              ...
              {restoredImage && originalPhoto && !sideBySide && (
                <div className="flex sm:space-x-4 sm:flex-row flex-col">
                  <div>
                    <h2 className="text-black mb-1 font-medium text-lg">Original room</h2>
                    <Image
                      alt="original photo"
                      src={originalPhoto}
                  ...
                  <div className="sm:mt-0 mt-8">
                    <h2 className="text-black mb-1 font-medium text-lg">Generated room</h2>
              ...
              <div className="flex space-x-2 justify-center">
                {originalPhoto && !loading && !error && (
                  <button
                    ...
                    className="text-black bg-blue-500 rounded-full font-medium px-4 py-2 mt-8 hover:bg-blue-500/80 transition"
                  >
                    Generate new room
                  </button>
                )}
                {restoredLoaded && (
                  <button
                    ...
                    className="text-black bg-white rounded-full text-black border font-medium px-4 py-2 mt-8 hover:bg-gray-100 transition"
                  >
